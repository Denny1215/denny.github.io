...
//use addition and if else
  ...
  let Grade5 = document.getElementById("txtGrade5").value;
    ...
    let total = parseInt(Grade1) + parseInt(Grade2) + parseInt(Grade3) 
              + parseInt(Grade4) + parseInt(Grade5);
    console.log(total);
  ...
  if (Average >= 97 && Average <= 100) {
    ...
    document.getElementById("spnGrade").innerText = 1.50;
    ...
    document.getElementById("spnGrade").innerText = 2.50;
